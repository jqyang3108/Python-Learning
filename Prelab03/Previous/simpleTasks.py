...
if __name__ == "__main__":
    ...
    bList3 =[True, 1,0,22]
    sequence = "4254354452348"
    sequence2 = "314X9X"
    names = ["George Smith", "Mark Johnson", "Cordell Theodore", "Maria Satterfield", "Johnson Cadence"]
    #result = find(pattern)
    #result = getStreakProduct(sequence, 3, 32)
    result = writePyramids("pyramid17.txt", 15,5,"*")
    #result =convertToInteger(bList2)
    #result =convertToBoolean(9,10)
